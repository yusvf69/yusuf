            ...
            >
              <div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-4 text-foreground hover:text-primary transition-all font-mono text-sm group interactive p-4 border border-border/50 rounded-xl bg-background/50 hover:bg-card w-full"
                >
